...
CREATE TABLE `basket` (
  ...
  `count` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3080 DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `favourites` VALUES (676,12,3),(1900,24,2),(1932,27,3),(1933,27,1),(1990,18,2),(1991,30,2),(2000,26,1);
...
INSERT INTO `wallets` VALUES (1,18,914566.00),(2,26,344701.00),(3,27,10000.00),(4,29,10000.00),(5,30,10000.00),(6,31,10000.00),(7,50,0.00),(8,48,0.00);
...
-- Dump completed on 2026-03-05 16:08:34
