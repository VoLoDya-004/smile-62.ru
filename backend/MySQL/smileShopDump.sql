...
CREATE TABLE `basket` (
  ...
  `count` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3172 DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `basket` VALUES (1773,12,4,1),(1774,12,3,1),(2789,24,5,1),(2790,24,4,1),(2826,27,3,1),(2827,27,4,1),(2828,27,5,1),(3018,30,3,2),(3019,30,2,1),(3081,81,3,1),(3170,80,8,1),(3171,26,9,1);
...
CREATE TABLE `favourites` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2032 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `favourites` VALUES (676,12,3),(1900,24,2),(1932,27,3),(1933,27,1),(1990,18,2),(1991,30,2),(2003,81,3),(2004,81,2),(2005,33,24),(2030,80,29),(2031,26,3);
...
INSERT INTO `user_tokens` VALUES (102,26,'13f86165b9bdc55aef5607c58816ed8cc6d1b6434d784de540ca6abdc0f7a338','2026-04-30 21:37:47','2026-03-28 15:32:27');
...
INSERT INTO `wallets` VALUES (1,18,914566.00),(2,26,392855.61),(3,27,10000.00),(4,29,10000.00),(5,30,10000.00),(6,31,57566.00),(7,50,0.00),(8,48,106354.00),(17,81,220500.00),(18,79,376264.00),(19,72,138307.00),(20,73,215750.00),(21,61,326678.00),(22,54,358610.00),(23,47,693453.00),(24,41,23000.00),(25,38,422299.00),(26,37,131419.00),(27,33,332654.16),(28,70,258064.00),(50,80,54956.00);
...
-- Dump completed on 2026-03-31 21:47:37
