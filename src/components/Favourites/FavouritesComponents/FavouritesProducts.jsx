...
export default function FavouritesProducts({product, deleteProduct, increase, decrease, changeValue}) {
    ...
    return (
        ...
        <div className="favouritesBox__product">
            ...
            <div className="favouritesBox__product_title">{title}</div>
            <div className="favouritesBox__product_count">
                <div className="favouritesBox__product_count-box">
                    <input onChange={(e) => {changeValue(id, +e.target.value)}} className="favouritesBox__product_count-input" 
                    type="number" min="1" max="100" value={count} />
                </div>
                <div className="favouritesBox__product_count-controls">
            ...
            <div className="favouritesBox__product_price">{priceFormatter.format(priceTotal)} руб.</div>           
