...
interface IConfirmModalAllFavProps {
    isOpen: boolean
    onConfirm: () => void
    onCancel: () => void
}
...
const ConfirmModalAllFav: React.FC<IConfirmModalAllFavProps> = ({ isOpen, onConfirm, onCancel }) => {
    ...
    const portalTarget = document.getElementById("confirmModalFavDeleteAll")
    if(!portalTarget) {
        return null
    }
...
export default  ConfirmModalAllFav